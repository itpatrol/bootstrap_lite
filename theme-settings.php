...
function bootstrap_lite_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['tweaks']['bootstrap_lite_container'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_container'),
  ...
  $form['tweaks']['bootstrap_lite_datetime'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_datetime'),
  ...
  $form['breadcrumbs']['bootstrap_lite_breadcrumb_home'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_breadcrumb_home'),
  ...
  $form['breadcrumbs']['bootstrap_lite_breadcrumb_title'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_breadcrumb_title'),
  ...
  $form['navbar']['bootstrap_lite_navbar_position'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_navbar_position'),
    '#options' => array(
  ...
  $form['navbar']['bootstrap_lite_navbar_menu_position'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_navbar_menu_position'),
    '#options' => array(
      'navbar-left' => t('Left'),
  ...
  $form['navbar']['bootstrap_lite_navbar_inverse'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_navbar_inverse'),
  );
  ...
  $form['bootstrap_lite_cdn']['bootstrap_lite_cdn'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_cdn'),
  ...
  $form['bootstrap_lite_cdn']['bootstrap_lite_font_awesome'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_lite_font_awesome'),
    '#empty_option' => t('Disabled'),
    '#empty_value' => NULL,
  );
  ...
  $default_theme_details = array(
    ...
    'thumbnail' => base_path() . drupal_get_path('theme', 'bootstrap_lite') . '/preview.jpg',
  );
  ...
  $form['bootswatch']['bootstrap_lite_bootswatch'] = array(
    '#type' => 'radios',
    '#default_value' => theme_get_setting('bootstrap_lite_bootswatch'),
